...
- 페이지
  - 사용자 페이지
    - 비로그인 상태, 일반 사용자가 볼 수 있는 페이지
      - 관리자 로그인으로 URL 이동은 가능
      - 추가로 내용을 살펴보니, 조금 수정해야 할 부분을 찾아서 수정하고 다시 작성 필요
    - 메인 페이지
...
- 메인헤더, 채팅, 모달
  ...
  - 관리자 페이지
    ...
    - 채팅
      ...
      - 사용자 리스트에서 모든 사용자를 볼 수 있고, 검색도 가능
        - 현재는 사용자 이름으로만 검색이 가능하고, 사용자 이메일도 검색되도록 하는 내용은 고려 중
